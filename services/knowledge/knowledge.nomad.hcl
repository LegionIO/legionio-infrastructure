variable "image" {
  type        = string
  default     = "ghcr.io/legionio/legion-knowledge:latest"
  description = "Container image for legion-knowledge"
}

variable "count" {
  type        = number
  default     = 2
  description = "Number of knowledge worker instances"
}
